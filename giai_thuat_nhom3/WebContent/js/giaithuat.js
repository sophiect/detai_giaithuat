				...
				.ajax({
					...
					success : function(dataObj) {
						...
						if (data != null) {
							...
							var t = "<table class='table-hover' style='width:100%; text-align: center; font-size: medium;'><tr style='height: 100px; background-color: rgba(108, 224, 255, 0.25); font-size: 16px; color: royalblue;'><th> Lần</th><th> Tên giải thuật</th><th> Thời gian</th><th> Điểm 1</th><th> Điểm 2</th><th> Khoảng cách</th></tr>";
